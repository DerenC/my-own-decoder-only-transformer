...
from bpe_tokenizer import encode, decode, final_vocab_size

'''
Conclusion: Sadly using a bpe tokeniser does not improve the loss
'''
...
eval_interval = 10 # Originally suggested: 500
