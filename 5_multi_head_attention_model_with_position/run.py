import torch
from multi_head_self_attention_model_with_position import MultiHeadSelfAttentionModelWithPosition
...
## TRAINING THE MODEL
model = MultiHeadSelfAttentionModelWithPosition(vocab_size, emb_dim, emb_dim, block_size)
