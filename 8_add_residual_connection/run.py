import torch
from multi_transformer_blocks_w_residual_connection import MultiTransformerBlocksWithResidualConnection
...
## TRAINING THE MODEL
model = MultiTransformerBlocksWithResidualConnection(vocab_size, emb_dim, block_size)
