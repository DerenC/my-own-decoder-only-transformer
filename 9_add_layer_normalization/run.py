import torch
from multi_transformer_blocks_w_residual_connection_n_pre_norm import MultiTransformerBlocksWithResidualConnectionNLayerNorm
...
## TRAINING THE MODEL
model = MultiTransformerBlocksWithResidualConnectionNLayerNorm(vocab_size, emb_dim, block_size)
